...
export const routes = [
  {
    ...
    // Land road coordinates [lat, lng] strictly along Jl. Trans Sulawesi & Perkotaan
    coordinates: [
  ...
  },
  {
    ...
    // Land road across Limboto - Isimu - Mountain pass - Kwandang
    coordinates: [
  ...
  },
  {
    ...
    // Land road: Dungingi -> Limboto -> Isimu -> Pulubala -> Paguyaman -> Tilamuta -> Paguat -> Marisa
    coordinates: [
      [0.5408, 123.0589], // Dungingi
      [0.5821, 123.0360], // Telaga
      [0.6277, 122.9818], // Limboto
  ...
  },
  {
    ...
    // Land road: Dungingi -> UNG -> Kabila -> Suwawa
    coordinates: [
      [0.5408, 123.0589], // Dungingi
      [0.5480, 123.0595],
      [0.5562, 123.0618], // UNG
  ...
  },
  {
    ...
    // Land coastal & city road: Otanaha -> UNG -> Taruna -> Leato -> Botubarani
    coordinates: [
